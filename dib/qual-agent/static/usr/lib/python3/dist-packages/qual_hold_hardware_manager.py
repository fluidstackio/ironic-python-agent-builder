...
This is the ramdisk-side half of qualification, shipped as part of the
`qual-agent` element. The node boots the IPA ramdisk ("qualOS"); this step runs
**automatically** as part of Ironic
