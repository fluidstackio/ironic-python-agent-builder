...
This element currently ships only a throwaway ``sleep_test`` clean step to
**prove that behaviour on real hardware** before the rest is built on it. See
``docs/qual-clean-timer-verification.md`` for the procedure.
